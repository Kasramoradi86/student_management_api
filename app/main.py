...
from .handler import student_not_found_handler,classroom_not_found_handler,classroom_has_student_handler,student_already_in_classroom_handler
...
app.add_exception_handler(ClassRoomHasStudentException,classroom_has_student_handler)
app.add_exception_handler(StudentAlreadyInClassroomException,student_already_in_classroom_handler)
